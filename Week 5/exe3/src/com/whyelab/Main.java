...
public class Main {
    ...
    private static int calculateArea(String descriptor) throws NumberFormatException, IllegalShapeException, IndexOutOfBoundsException {
        //TODO: modify the code below
